...
const TaSidebar = class {
    ...
    get userMenu() {
        const createNewMenu = (h("div", { class: "menu-content-wrapper" }, h("span", { class: "menu-item", onClick: () => this.history.push('#createApplication') }, "New Application", h("ta-icon", { icon: "add" }))));
        return (h("span", null, h("div", { class: "add-btn" }, h("ta-dropdown", { overlay: createNewMenu, onTaOverlayRendered: this.handleOverlayRendered }, h("ta-button", null, h("div", { class: "add-btn-label" }, "Create New", h("div", { class: {
            ...
            } }, h("ta-icon", { icon: "add" })))))), h("div", { class: "links" }, h("ta-sidebar-item", { class: "first", icon: "home", to: "/dashboard" }, "Dashboard"), h("ta-sidebar-item", { icon: "applications", to: "/applications" }, "My Applications"), h("ta-sidebar-item", { icon: "settings", to: "/settings" }, "Settings"))));
    }
    render() {
        return (h("div", { class: "ta-sidebar-container" }, h("div", { class: "ta-sidebar-wrapper" }, h("div", { class: "sidebar-top" }, h("div", { class: "logo" }, "Mahi"), this.userMenu), h("div", { class: "sidebar-bottom" }))));
    }
