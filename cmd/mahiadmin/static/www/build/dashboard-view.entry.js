...
import { g as generateParams, m as me, b as byteToGB } from './index-d97fcc51.js';
import { g as get } from './base-1320a4aa.js';
    ...
    render() {
        ...
        return (h(Host, null, h("ta-app-page", null, h("ta-page-header", { pageTitle: "Dashboard" }, h("div", { slot: "right" }, h("div", { class: "page-action-wrapper" }, h("div", { class: {
            ...
            ?
                h("ta-loader", null)
            :
                h("div", null, h("div", { class: "stats-wrapper" }, h("ta-stat-card", { icon: "storage-disks", label: "Total Storage", value: `${byteToGB(totals.storage)}GB` }), h("ta-stat-card", { icon: "dashboard", label: "Total Bandwidth", value: `${byteToGB(totals.bandwidth)}GB` }), h("ta-stat-card", { icon: "transformations", label: "Transformations", value: `${totals.transformations}` })), h("ta-card", null, h("div", null, "Usage"), h("ta-line-graph", { labels: this.metricLabels(), datasets: this.metricDatasets() })), h("ta-recent-applications-list", null)))));
    }
};
