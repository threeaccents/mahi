...
const ResetPasswordView = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: 'auth-view' }, h("div", { class: 'auth-form-wrapper' }, h("div", { class: 'auth-form' }, h("img", { class: 'logo', src: '../../static/logo.svg', alt: '' }), h("ta-form-label", null, "Reset Password"), h("ta-form", { onTaSubmit: this.onSubmit }, h("ta-input", { label: 'New Password', type: 'password', value: this.password, onTaInput: (e) => this.password = e.detail }), h("ta-input", { class: "last", label: 'Confirm Password', type: 'password', value: this.confirmPassword, onTaInput: (e) => this.confirmPassword = e.detail }), h("div", { class: 'forgot-password-text' }, h("stencil-route-link", { url: "/auth" }, h("p", null, "Back to login?"))), h("ta-button", { disabled: !this.canSubmit, loading: this.fetchingApi, onTaClick: this.onSubmit }, "Submit")))), h("div", { class: 'auth-image-wrapper' }), h("div", { class: "copyright-text" }, h("p", null, "Copyright \u00A9 ", new Date().getFullYear(), " Oriio. All rights reserved.")))));
    }
};
ResetPasswordView.style = resetPasswordViewCss;

export { ResetPasswordView as reset_password_view };
