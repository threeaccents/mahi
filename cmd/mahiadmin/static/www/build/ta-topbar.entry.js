...
const TaTopbar = class {
    ...
    render() {
        return (h(Host, null, h("div", { class: "logo" }, h("img", { src: '../../static/logo.svg', alt: '' })), h("div", { class: "right-side" }, me().isAdmin ?
            h("div", { class: "usage" }, h("div", { class: "usage-title" }, "USAGE"), h("div", { class: "usage-amount" }, "$", this.amountDue))
            : null, h("div", { class: "toggle-menu" }, h("div", { onClick: () => this.taHamburgerClicked.emit(), innerHTML: barIcon })))));
    }
};
